...
},{"d3-collection":"../node_modules/d3-collection/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js"}],"data/us_states.json":[function(require,module,exports) {
module.exports="/us_states.2e22958a.json";
},{}],"data/RallyLocations.csv":[function(require,module,exports) {
module.exports = "/RallyLocations.3560cd4b.csv";
...
function ready(_ref) {
  ...
  svg.selectAll('.state').data(states.features).enter().append('path').attr('class', 'state').attr('d', path).attr('fill', function (d) {
  ...
  }).attr('text-anchor', 'middle').style('font-size', 10).style('fill', 'white');
  ...
  function render() {
    ...
    svg.selectAll('.rallies').attr('transform', function (d) {
      var coords = projection([d.lng, d.lat]);
      return "translate(".concat(coords, ")");
    });
    svg.selectAll('.state-label').attr('transform', function (d) {
      return "translate(".concat(path.centroid(d), ")");
    }); // // Update axes
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","d3-tip":"../node_modules/d3-tip/index.js","/data/us_states.json":"data/us_states.json","/data/RallyLocations.csv":"data/RallyLocations.csv"}]},{},["scripts/chart-01.js"], null)
